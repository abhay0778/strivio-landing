        ...
        <div className="mt-24 grid gap-y-24 gap-x-16 md:grid-cols-2 md:gap-x-24">
          {founders.map((f, i) => (
            <Reveal key={f.name} delay={i * 0.1}>
              <div
                className="founder-card group relative rounded-2xl border border-[#1e1e1e] bg-[#0a0a0a] pl-[46%] pr-6 py-10 md:pl-[42%] md:pr-10 md:py-12 transition-all duration-300 hover:border-[rgba(245,197,24,0.35)] hover:-translate-y-1"
                style={{ overflow: "visible" }}
              >
                <div className="founder-photo pointer-events-none absolute left-0 bottom-0 h-[360px] w-[200px] md:h-[420px] md:w-[280px] translate-x-0 md:-translate-x-[40%] flex items-end justify-center transition-transform duration-500 group-hover:-translate-y-2">
                  <div
